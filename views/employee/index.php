                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="" value="<?php echo $_SESSION['emp_name'];?>" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="lastName" placeholder="" value="<?php echo $_SESSION['emp_lastName'];?>">
                        </div>
                        <div class="col-md-8">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" placeholder="user@example.com" value="<?php echo $_SESSION['emp_email'];?>" required>
                            <div class="invalid-feedback">
